      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 content-below-fold">
          <div className="flex flex-row flex-wrap md:flex-row md:flex-wrap gap-4 md:gap-8 justify-center items-start">
            <Link href="/tips" className="md-text-button md:hidden">
              検索のコツ
            </Link>
            <a href="/about" className="md-text-button md:hidden">
              このサイトについて
            </a>
            {process.env.NODE_ENV !== "production" && (
              <a href="/sync" className="md-text-button md:hidden">
                データ同期ページ
              </a>
            )}
            <Link href="/coffee" className="md-text-button md:hidden">
              コーヒーを奢る
            </Link>
            <a
              ...
              className="md-text-button md:hidden"
            >
              Developed by miozuma
            </a>
            <div className="hidden md:flex flex-row flex-wrap gap-8 justify-center items-start">
